...
@NamedQueries({
   ...
   ,@NamedQuery(name = "Player.updateDeck", query = "UPDATE Player p SET p.deck = :deck WHERE p.username = :username")
   ,@NamedQuery(name = "Player.findDeck", query = "SELECT p.deck FROM Player p WHERE p.username = :username")
})
